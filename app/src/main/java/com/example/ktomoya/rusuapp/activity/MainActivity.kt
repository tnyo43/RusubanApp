...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btn_goto_voice_message).setOnClickListener{
            val intent = Intent(this, VoiceMessageActivity::class.java)
            startActivity(intent)
        }
        findViewById<Button>(R.id.btn_goto_key).setOnClickListener{
            val intent = Intent(this, KeyActivity::class.java)
            startActivity(intent)
        }
        findViewById<Button>(R.id.btn_goto_gallery).setOnClickListener{
